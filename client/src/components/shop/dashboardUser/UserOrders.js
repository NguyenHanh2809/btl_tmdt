    ...
    <Fragment>
      <thead>
        <tr>
          ...
          <th className="px-4 py-2 border">Ngày Thanh Toán</th>
          <th className="px-4 py-2 border">Ngày Xử Lý</th>
        </tr>
      </thead>
    </Fragment>
  );
        ...
        <td className="hover:bg-gray-200 p-2 text-center cursor-default">
          ...
          {order.status === "Shipped" && (
            <span className="block text-blue-600 rounded-full text-center text-xs px-2 font-semibold">
              Đã được chuyển cho đơn vị giao hàng
            </span>
          )}
        ...
        <div className="border">
          ...
          <div className="overflow-auto bg-white shadow-lg p-4">
            ...
            <div className="text-sm text-gray-600 mt-2">
              Tìm thấy {orders && orders.length} đơn hàng
            </div>
          </div>
        </div>
      </div>
